...
if($footer_row2 == 2)
{
	$footer_row2_colwidth = ($footer_row2_width - $footer_sidepadding) / 2;	
}
else if($footer_row2 == 3)
{
	$footer_row2_colwidth = ($footer_row2_width - $footer_sidepadding * 2) / 3;	
}
else if($footer_row2 == 4)
{
	$footer_row2_colwidth = ($footer_row2_width - $footer_sidepadding * 3) / 4;	
}
